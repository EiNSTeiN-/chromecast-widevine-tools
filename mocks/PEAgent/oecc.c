...
int _oecc01(int a1)
{
  printf("(mock) _oecc01 // OEMCrypto_Initialize\n");
  return 0;
}

int _oecc02(int a1)
{
  printf("(mock) _oecc02 // OEMCrypto_Terminate\n");
  return 0;
}
...
{
  printf("(mock) _oecc06 // Get random data\n");
...
{
  printf("(mock) _oecc09 // OpenSession\n");
  *p_session_id = 0x800;
  return 0;
}
...
{
  printf("(mock) _oecc14 // Generate nonce\n");
  *nonce = 0x04040404;
  return 0;
}
